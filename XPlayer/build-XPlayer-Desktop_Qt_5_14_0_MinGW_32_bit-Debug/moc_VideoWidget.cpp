...
#include <memory>
#include "../XPlayer/frame/VideoWidget.h"
...
QT_MOC_LITERAL(1, 12, 17), // "DecodeVideoSignal"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 5), // "char*"
QT_MOC_LITERAL(4, 37, 4), // "path"
QT_MOC_LITERAL(5, 42, 15), // "VideoImageSlots"
QT_MOC_LITERAL(6, 58, 7), // "QImage&"
QT_MOC_LITERAL(7, 66, 5) // "image"

    },
    "VideoWidget\0DecodeVideoSignal\0\0char*\0"
    "path\0VideoImageSlots\0QImage&\0image"
};
...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DecodeVideoSignal((*reinterpret_cast< char*(*)>(_a[1]))); break;
        case 1: _t->VideoImageSlots((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VideoWidget::*)(char * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::DecodeVideoSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoWidget::DecodeVideoSignal(char * _t1)
{
